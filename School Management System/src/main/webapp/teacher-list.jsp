        ...
        <body>
            ...
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="https://www.javaguides.net" class="navbar-brand"> Teacher
     Management Application </a>
                    </div>
                    

                    <ul class="navbar-nav">
                        <li><a href="<%=request.getContextPath()%>/teacher/list" class="nav-link">Teacher</a></li>
                    </ul>
                        ...
                        <tbody>
                            ...
                            <c:forEach var="teacher" items="${listTeacher}">
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit?id=<c:out value='${teacher.id}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="delete?id=<c:out value='${teacher.id}' />">Delete</a></td>
                                </tr>
                            </c:forEach>
                            <!-- } -->
                        </tbody>
